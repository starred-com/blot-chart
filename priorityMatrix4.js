...
const minY = d3.min(newData, d => d['fact_table.abs_correlation_coefficient']['rendered'])
const maxY = d3.max(newData, d => d['fact_table.abs_correlation_coefficient']['rendered'])
