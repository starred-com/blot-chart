...
const Dimension1 = queryResponse.fields.dimensions[0].name //returns the name of the first dimension 
const Dimension2 = queryResponse.fields.dimensions[1].name //returns the name of the second dimension 
const Measure1 = queryResponse.fields.measures[0].name //returns the name of the first measure

console.log(Dimension1); 
console.log(Dimension2); 
console.log(Measure1);

//FORMATTING OPTIONS LISTED BELOW, PICK ONE OF THE FOLLOWING 
//option 1: create arrary with list of values
formattedDataAsList = []
data.forEach(function(d) {
  formattedDataAsList.push( d[Measure1]["value"] );
});

console.log(formattedDataAsList);

//creates new empty array
data.forEach(function(d) { formattedDataAsPairs[d[Dimension1]["value"]] = d[Measure1]["value"] })

console.log(formattedDataAsPairs); // Will show data object in console log
