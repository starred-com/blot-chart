const visObject = {
  ...
  updateAsync: function (data, element, config, queryResponse, details, doneRendering) {
    ...
    const newTotalResponse = (queryResponse?.totals_data[uniqueRatings] !== null && typeof queryResponse?.totals_data[uniqueRatings] !== 'undefined') ? queryResponse.totals_data[uniqueRatings]?.value : totalResponse; //total_response
    const totalAvgStarRating = queryResponse?.totals_data[averageRating] ? queryResponse.totals_data[averageRating].value : null; //total_data_avg_star_rating
    ...
    function message() {
      ...
      svg.append("image")
      .attr('xlink:href', 'https://cdn.starred.com/downloads/looker/respondents-found.png')
      .attr("width", "100%")
      .attr("height", "100%");
    }
