const visObject = {
  updateAsync: function (queryResponse, data, element, config, details, doneRendering) {
    ...
    const questionSubject = queryResponse ? queryResponse.fields.dimensions[0].name : null; //questions.subject
    const questionQuestion = queryResponse ? queryResponse.fields.dimension_like[1].name : null; //questions.question
